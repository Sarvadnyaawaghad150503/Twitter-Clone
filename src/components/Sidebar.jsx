...
const Sidebar = () => {
  return (
    <div className="flex flex-col w-1/4 h-full overflow-scroll justify-start items-start px-10">
      <Link to="/">
        <img src="https://res.cloudinary.com/sarveshp46/image/upload/v1671113197/twitter-workshop/twitter_mswkcv.png" alt="twitter-logo" className="w-10 m-3 cursor-pointer"/>
      </Link>
      ...
      <MenuItem title="Profile" 
        ...
        link="#"/>
          ...
          {/* tweet button */}
         <button className="bg-blue-500 w-56 rounded-full font-bold text-white text-xl p-4 my-2 hover:bg-blue-600">Tweet</button>
